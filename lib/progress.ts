...
import { notifyTMSCourseCompleted, notifyTMSCertificateIssued } from "@/lib/tms-webhook-service";
        ...
        if (!existingCert) {
            const cert = await db.certificate.create({
                data: {
                    ...
                    certificateNumber: generateCertificateNumber(enrollment.edition?.code),
                },
            });
