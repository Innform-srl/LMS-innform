 ...
 */
export async function generateCertificatePDF(data: CertificateData, settings: CertificateSettings): Promise<Buffer> {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            doc.fontSize(14).font("Helvetica").fillColor("#000000").text("Questo certifica che", 0, yPosition, {
                align: "center",
                width: pageWidth,
            });
            ...
            doc.fontSize(28).font("Helvetica-Bold").fillColor(settings.primaryColor).text(data.userName, 0, yPosition, {
                align: "center",
                width: pageWidth,
            });
            ...
            // Course Title
            doc.fontSize(20).font("Helvetica-Bold").fillColor("#000000").text(data.courseTitle, 0, yPosition, {
                align: "center",
                width: pageWidth,
            });
            ...
            if (data.editionTitle) {
                doc.fontSize(13).font("Helvetica").fillColor("#555555").text(data.editionTitle, 0, yPosition, {
                    align: "center",
                    width: pageWidth,
                });
                yPosition += 25;
            ...
            doc.fontSize(10).fillColor("#666666").text(`Certificato n° ${data.certificateNumber}`, 70, footerY, {
                align: "left",
            });

            doc.fontSize(9).text(formatDate(data.completionDate), 70, footerY + 15, {
                align: "left",
            });
            ...
            // Signature line
            doc.moveTo(centerX - 80, footerY + 18)
