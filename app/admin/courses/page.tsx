            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <Card className="bg-[#f0e7db] border-none shadow-sm p-6">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-[#0091ff] rounded-2xl flex items-center justify-center shadow-sm">
                        ...
                        <Card className="bg-[#f0e7db] border-none shadow-sm p-6">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-[#00c853] rounded-2xl flex items-center justify-center shadow-sm">
                                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <Card className="bg-[#f0e7db] border-none shadow-sm p-6">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-[#ff9800] rounded-2xl flex items-center justify-center shadow-sm">
                                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
